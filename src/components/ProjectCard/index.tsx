...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  const handleContactClick = () => {
    ...
    window.open(
      `https://api.whatsapp.com/send/?phone=966920031404&text=${encodeURIComponent(message)}&type=phone_number&app_absent=0`,
      "_blank",
    );
  };
      ...
      <div className="project-card-content">
        ...
        <div className="project-card-actions">
          ...
          >
            ...
            <img
              src="https://alzamiliah.com/images/logo/pin_3177361.png"
              alt=""
              width={13}
              height={13}
            />
