  ...
  return (
    <div
      style={{
        ...
        background:
          'linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.5)), url("https://images.unsplash.com/photo-1497215728101-856f4ea42174?auto=format&fit=crop&w=2070&q=80")',
      ...
      >
        ...
        >
          <Image
            ...
            width={120}
            height={96}
            style={{ height: "96px", width: "auto", marginBottom: "15px" }}
          />
          <h2
            style={{
              color: "#fff",
