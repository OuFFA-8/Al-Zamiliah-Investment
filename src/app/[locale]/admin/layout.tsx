...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    const navItems = [
        ...
        { href: `/${locale}/admin/projects/new`, labelAr: 'إضافة مشروع جديد', labelEn: 'Add New Project' },
        { href: `/${locale}/admin/projects`, labelAr: 'إدارة المشاريع', labelEn: 'Manage Projects' },
        { href: `/${locale}/admin/apartments`, labelAr: 'أدارة الشقق والمباني', labelEn: 'Apartments & Buildings' },
        { href: `/${locale}/admin/contacts`, labelAr: 'طلبات التواصل', labelEn: 'Contact Requests' },
        { href: `/${locale}/admin/statistics`, labelAr: 'أحصائيات الموقع', labelEn: 'Site Statistics' },
        { href: `/${locale}/admin/promotion`, labelAr: 'ترويج للموقع', labelEn: 'Site Promotion' },
        { href: `/${locale}/admin/content`, labelAr: 'سياسات وخصوصية', labelEn: 'Policies & Privacy' },
    ];
                ...
                <div className="admin-topnav-inner">
                    <div className="admin-topnav-content">
                        ...
                        <div className="admin-topnav-logo">
                            <Link href={`/${locale}`}>
                                <Image src="/images/logow.png" alt="الزاملية" width={80} height={40} style={{ height: '50px', width: 'auto', paddingTop: '8px', paddingBottom: '8px' }} />
                            </Link>
                        </div>
                        ...
                        <div className="admin-topnav-links">
                            ...
                            {/* View website icon */}
                            <Link href={`/${locale}`} target="_blank" className="admin-topnav-link" title={isRTL ? 'عرض الموقع' : 'View Website'}>
                        ...
                        <div className="admin-topnav-user">
                            {user && <span className="admin-topnav-username">{user.name}</span>}
                            <button onClick={handleLogout} className="admin-topnav-logout" title={isRTL ? 'تسجيل الخروج' : 'Logout'}>
                        ...
                        {/* Mobile hamburger */}
                        <button className="admin-topnav-hamburger" onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
                    ...
                    {mobileMenuOpen && (
                        <div className="admin-topnav-mobile">
                            ...
                            <button onClick={handleLogout} className="admin-topnav-mobile-link" style={{ color: '#ef4444', border: 'none', background: 'none', textAlign: isRTL ? 'right' : 'left', cursor: 'pointer' }}>
