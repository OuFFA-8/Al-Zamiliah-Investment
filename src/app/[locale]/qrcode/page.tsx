...
export default function QrCodePage() {
    ...
    const validate = () => {
        ...
        if (!form.name.trim()) e.name = isRTL ? 'يرجى إدخال الاسم الكريم' : 'Please enter your name';
        if (!form.phone.trim()) {
    ...
    const contentStyle: React.CSSProperties = {
        ...
        ...(isLg
            ? isRTL
                ? { paddingRight: `${SIDEBAR_W}px` }
                : { paddingLeft: `${SIDEBAR_W}px` }
            : {}),
    };
        ...
        <div style={{ position: 'relative', minHeight: '100vh', direction: isRTL ? 'rtl' : 'ltr' }}>
            ...
            <aside style={sidebarStyle}>
                <div style={{ padding: '32px 24px', display: 'flex', flexDirection: 'column', flex: 1, overflowY: 'auto' }}>
                    ...
                    {/* Language */}
                    <Link href={`/${otherLocale}/qrcode`} style={{
                ...
                <div style={{ maxWidth: '820px', margin: '0 auto', padding: '48px 28px 64px' }}>
                    ...
                    <div style={{ textAlign: 'center', color: '#fff', marginBottom: '36px' }}>
                        <div style={{
                            ...
                            background: 'rgba(197,168,128,0.18)', border: '1px solid rgba(197,168,128,0.35)',
                            color: '#c5a880', marginBottom: '18px',
                        }}>
                            <Award size={13} />
                        ...
                        <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.75)', margin: 0, lineHeight: 1.6 }}>
                            {isRTL
                                ? 'مشاريع سكنية وتجارية فاخرة تلبي تطلعاتك وتضمن استثمارك'
                                : 'Luxury residential and commercial projects that secure your investment'}
                        </p>
                    </div>
                    ...
                    {success && (
                        <div style={{
                            ...
                            boxShadow: '0 8px 32px rgba(92,58,33,0.18)',
                            ...
                            <div style={{
                                ...
                                <CheckCircle2 size={34} style={{ color: '#c5a880' }} />
                            </div>
                            <h2 style={{ fontSize: '20px', fontWeight: 800, color: '#5c3a21', margin: '0 0 10px' }}>
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    background: '#5c3a21', color: '#fff', fontWeight: 700,
                    ...
                    {!success && (
                        <div id="qr-form" style={{
                            ...
                            {/* Card top bar */}
                            <div style={{
                                background: '#faf8f5', borderBottom: '1px solid #f0ece6',
                                padding: '14px 24px', display: 'flex', justifyContent: 'center',
                            }}>
                                <span style={{
                                    background: '#5c3a21', color: '#fff',
                                    padding: '6px 24px', borderRadius: '999px',
                            ...
                            <div style={{ padding: '28px 28px 32px' }}>
                                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            style={{
                                                ...
                                                border: `1.5px solid ${errors.name ? '#f87171' : '#e5e7eb'}`,
                                                background: errors.name ? '#fef2f2' : '#fff', outline: 'none',
                                    ...
                                    <div>
                                        ...
                                        <input
                                            type="tel" dir="ltr" placeholder="05xxxxxxxx" value={form.phone}
                                            onChange={e => { setForm(p => ({ ...p, phone: e.target.value })); if (errors.phone) setErrors(p => ({ ...p, phone: '' })); }}
                                            style={{
                                                width: '100%', padding: '11px 14px', fontSize: '14px', borderRadius: '8px',
                                                border: `1.5px solid ${errors.phone ? '#f87171' : '#e5e7eb'}`,
                                                background: errors.phone ? '#fef2f2' : '#fff', outline: 'none',
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            style={{
                                                ...
                                                background: errors.email ? '#fef2f2' : '#fff', outline: 'none',
                                                textAlign: isRTL ? 'right' : 'left', boxSizing: 'border-box',
                                            }}
                                        />
                                        ...
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                                            <h3 style={{ fontSize: '13px', fontWeight: 700, color: '#1f2937', margin: 0 }}>
                                                ...
                                                <span style={{ fontSize: '11px', fontWeight: 400, color: '#9ca3af', marginRight: isRTL ? '6px' : 0, marginLeft: isRTL ? 0 : '6px' }}>
                                                    {isRTL ? '(اختر ما يناسبك)' : '(select any)'}
                                                </span>
                                            </h3>
                                            {selectedIds.length > 0 && (
                                                <span style={{
                                                    fontSize: '11px', fontWeight: 700, padding: '2px 10px',
                                                    borderRadius: '999px', background: 'rgba(197,168,128,0.15)', color: '#5c3a21',
                                                }}>
                                                ...
                                                {projects.map(project => {
                                                    ...
                                                    return (
                                                        <div
                                                            ...
                                                            style={{
                                                                borderRadius: '10px', overflow: 'hidden', cursor: isSoon ? 'not-allowed' : 'pointer',
                                                        ...
                                                        >
                                                            <div style={{ position: 'relative', width: '100%', height: '120px', background: '#f3f4f6', overflow: 'hidden' }}>
                                                                ...
                                                                {isSoon && (
                                                                    <div style={{
                                                                        ...
                                                                        justifyContent: 'center', color: '#fff', gap: '2px',
                                                                    }}>
                                                            ...
                                                            <div style={{ padding: '10px 12px', background: isSelected ? 'rgba(197,168,128,0.05)' : '#fff' }}>
                                                                ...
                                                                {(isRTL ? project.locationAr : project.locationEn || project.locationAr) && (
                                                                    <p style={{
                                                                        margin: '4px 0 0', fontSize: '11px', color: '#6b7280',
                                    ...
                                    {errors.api && (
                                        <div style={{
                                            color: '#ef4444', fontSize: '12px', display: 'flex', alignItems: 'center',
                                            gap: '6px', background: '#fef2f2', padding: '10px 14px',
                                    ...
                                    <button
                                        ...
                                        style={{
                                            ...
                                            background: sending ? '#9ca3af' : '#5c3a21', color: '#fff',
                                            fontWeight: 700, fontSize: '15px', border: 'none',
                                            cursor: sending ? 'not-allowed' : 'pointer',
                                            boxShadow: sending ? 'none' : '0 4px 16px rgba(92,58,33,0.3)',
                                            transition: 'background 0.2s',
                                        }}
                                    >
                                        {sending
                                            ? (isRTL ? 'جاري التسجيل...' : 'Submitting...')
                                            : (isRTL ? 'سجل اهتمامك' : 'Register Your Interest')}
                                    </button>
                                </form>
                            </div>
                            ...
                            return (
                                <div key={i} style={{ textAlign: 'center' }}>
                                    <div style={{
                                        ...
                                        background: 'rgba(197,168,128,0.14)', border: '1px solid rgba(197,168,128,0.25)',
                                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                                    }}>
                                        <Icon size={20} style={{ color: '#c5a880' }} />
                                    </div>
                                    <h4 style={{ fontWeight: 700, fontSize: '13px', margin: '0 0 4px', color: '#fff' }}>
                                        {isRTL ? b.titleAr : b.titleEn}
                                    </h4>
                                    <p style={{ color: '#9ca3af', fontSize: '11px', margin: 0 }}>
                                        {isRTL ? b.subAr : b.subEn}
                                    </p>
                                </div>
                            );
                        })}
