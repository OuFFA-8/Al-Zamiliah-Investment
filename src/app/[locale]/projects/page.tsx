...
const propertyTypeOptions = {
    en: [
        ...
        { value: 'أدوار', label: 'Floors' },
        { value: 'شقق', label: 'Apartments' },
        { value: 'عمائر', label: 'Buildings' },
        { value: 'سكني', label: 'Residential' },
        { value: 'تجاري', label: 'Commercial' },
        { value: 'مكتبي', label: 'Office' },
        { value: 'مخطط أراضي', label: 'Land Plan' },
        { value: 'مستودعات', label: 'Warehouses' },
        ...
        { value: 'مجمع سكني تجاري', label: 'Residential and Commercial Complex' },
        { value: 'مجمع تجاري', label: 'Commercial Complex' },
    ],
    ar: [
        { value: 'فلل', label: 'فلل' },
        ...
        { value: 'مخطط أراضي', label: 'مخطط أراضي' },
        ...
        { value: 'مجمع سكني تجاري', label: 'مجمع سكني تجاري' },
        { value: 'مجمع تجاري', label: 'مجمع تجاري' },
    ],
};
