  ...
  try {
    ...
    if (body.sortOrder != null) {
      const existing = await prisma.project.findFirst({
        where: {
          ...
          NOT: { id: projectId }, // استثني المشروع الحالي نفسه
        },
      });
      if (existing) {
    ...
    const project = await prisma.project.update({
      ...
      data: {
        ...
        image6: body.image6,
        buildingsCount:
          body.buildingsCount != null
            ? parseInt(body.buildingsCount)
            : undefined,
        unitsCount:
          body.unitsCount != null ? parseInt(body.unitsCount) : undefined,
        elevatorsCount:
          body.elevatorsCount != null
            ? parseInt(body.elevatorsCount)
            : undefined,
        sortOrder:
          body.sortOrder != null ? parseInt(body.sortOrder) : undefined,
        ...
        statusApartment:
          body.statusApartment != null
            ? parseInt(body.statusApartment)
            : undefined,
        availability:
          body.availability != null ? parseInt(body.availability) : undefined,
        isFeatured:
          body.isFeatured != null ? parseInt(body.isFeatured) : undefined,
        ...
        highQuality:
          body.highQuality != null ? parseInt(body.highQuality) : undefined,
        smartEntry:
          body.smartEntry != null ? parseInt(body.smartEntry) : undefined,
        fireSensor:
          body.fireSensor != null ? parseInt(body.fireSensor) : undefined,
        // Additional fields
        icon3d: body.icon3d,
        ...
        projectFileTitleAr: body.projectFileTitleAr,
        projectFileTitleEn: body.projectFileTitleEn,
        projectFile2: body.projectFile2,
        projectFile2TitleAr: body.projectFile2TitleAr,
        projectFile2TitleEn: body.projectFile2TitleEn,
        projectFile3: body.projectFile3,
        projectFile3TitleAr: body.projectFile3TitleAr,
        projectFile3TitleEn: body.projectFile3TitleEn,
